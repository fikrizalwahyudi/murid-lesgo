...
@Component({template: `<ion-nav [root]="rootPage"></ion-nav>`, providers: [Helper]})
export class MyApp {
  rootPage : any;
  pushObject : PushObject;

  constructor(public platform : Platform, public LoadingController : LoadingController, public network : Network, public push : Push, public helper : Helper,) {
    Splashscreen.show();
    var config = {
